...
DROP TABLE IF EXISTS PersonsForTasks;
...
INSERT INTO Suppliers VALUES(23,'Karkki Oy','Anne Heikkonen','Valtakatu 12','Lappeenranta','53120','Finlannd','(953) 10956');
...
INSERT INTO Persons (PersonId,FirstName,LastName,ManagerID) VALUES (1,'Jesse','Kontio',NULL), (2,'Lauri','Leppänen',1), (3,'Markku','Koistinen',2), (4,'Maija','Mäkinen',1), (5,'Lasse','Laitinen',2), (6,'Tiina','Immonen',4), (7,'Tauno','Mäkelä ',1), (8,'Teppo','Hirvonen',7), (9,'Tommi','Makkonen',7), (10,'Jaakko','Jäppinen',7), (11,'Ari','Nevalainen',3), (12,'Pekka','Järveläinen',3), (13,'Tuula','Laitinen',3), (14,'Timo','Ruotsalainen',2), (15,'Vesa','Venäläinen',14), (16,'Jaana','Mäkinen',14), (17,'Janne','Laitinen',14), (18,'Iikka','Immonen',14), (19,'Marjaana','Mäkelä ',9), (20,'Aune','Hirvonen',9), (21,'Jaakko','Makkonen',9), (22,'Mira','Jäppinen',9), (23,'Irja','Nevalainen',10), (24,'Kalle','Järveläinen',1), (25,'Leena','Laitinen',1), (26,'Hannu','Ruotsalainen',24), (27,'Ville','Venäläinen',25);

INSERT INTO Reclamations (CustomerID, ReclamationText, Response) VALUES (2, NULL, NULL), (3, 'Customer explanation of reclamation', NULL), (3, 'The cheese You sent was outdated','Very sorry to hear that. Please send us the Order number so we can send You a replacement');

INSERT INTO Tasks (TaskID, Title, PersonID) VALUES (1, 'Osta maitoa', 1), (2, 'Osta leipää', 1),(3, 'Ei tekijaa',NULL);

INSERT INTO PersonsForTasks (PersonID, Name, Email) VALUES  (1, 'Mikko', 'mikko@web.com'), (2, 'Maija', 'maija@web.com'),(3, 'Repe',NULL);

INSERT INTO PersonsV2 (Name, Email) VALUES ('Ari', 'ari@secora.fi'), ('Mikko', 'mikko@secora.fi'), ('Veikko', 'veikko@secora.fi');
INSERT INTO TasksV2(Title, MasterTaskID, DueDate) VALUES ('Ruuan laitto', NULL,NULL), ('Osta kaupasta kermaa', 1,NULL), ('Osta kaupasta voita', 1,NULL), ('Tee kalakeitto', 1, NULL), (' Maalaa talo', NULL, NULL), (' Suojaa ikkunat',5, NULL), (' Hanki maalit',5, NULL), (' Maalaa seinät',5, NULL), ('Task For Somebody (Nobody did)',NULL, NULL);
INSERT INTO Persons_Tasks (PersonID, TaskID, DueDate) VALUES (1,1, NULL), (2,2 , NULL), (2,3 , NULL), (1,4 , NULL), (1,5 , NULL), (2,6 , NULL), (1,7 , NULL), (1,8 , NULL);